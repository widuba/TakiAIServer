...
export function storeCategory(key: string): string {
  if (/^(?:user:|users:index$|userip:|devicecredential:|webauth:|privacy:deleted:|signup:ip:|user_|users_index$|userip_|devicecredential_|webauth_)/.test(key)) return "accounts";
