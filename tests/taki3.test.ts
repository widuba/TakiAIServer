...
test("Taki 3.0 rollout aliases remain gated and rollback-compatible", () => {
  ...
  assert.equal(shouldShadowTaki3({ TAKI_BRAIN_V4_MODE: "shadow", TAKI_BRAIN_V4_SHADOW_PERCENT: "100" }), true);
});
